...
function defineStore(idOrOptions, setup, setupOptions) {
  ...
  function useStore(pinia, hot) {
    ...
    (pinia) || currentInstance && inject$1(piniaSymbol, null);
    if (pinia)
      setActivePinia(pinia);
    pinia = activePinia;
    if (!pinia._s.has(id)) {
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [], "style": [], "script": [], "noscript": [], "title": "Learn Nuxt" };
...
const _routes = [
  ...
  },
  {
    ...
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/protected",
...
const startApp_wmLvgJX20e = /* @__PURE__ */ defineNuxtPlugin((nuxt) => {
});
